 ...
 *
 */
public class CHPEAPartDoNothing extends AbstractCHPEAPart {
	 ...
	 * @param timestamp
	 */
	public CHPEAPartDoNothing(UUID deviceId, long timestamp) {
		super(deviceId, timestamp, 0, 0, false);
	}
	

	@Override
	public Schedule getSchedule(BitSet solution) {
		return new Schedule(new SparseLoadProfile(), 0.0);
	}

	@Override
	public String problemToString() {
		return "chp: do nothing";
	}
