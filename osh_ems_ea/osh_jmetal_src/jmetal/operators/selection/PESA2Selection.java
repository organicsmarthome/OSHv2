...
public class PESA2Selection extends Selection {      
	...
	public PESA2Selection(HashMap<String, Object> parameters, PseudoRandom pseudoRandom) {
  ...
  */
  ...
  public Object execute(Object object) throws JMException    {
    try {
      ...
      int selected;        
      int hypercube1 = archive.getGrid().randomOccupiedHypercube(pseudoRandom);
      int hypercube2 = archive.getGrid().randomOccupiedHypercube(pseudoRandom);                                        
