...
/**
 * <p>Java-Klasse für ConfigurationParameter complex type.
 * 
...
public class ConfigurationParameter implements Cloneable
{
    ...
    /**
     * Creates a new {@code ConfigurationParameter} instance.
     * 
     */
    ...
    /**
     * Creates a new {@code ConfigurationParameter} instance by deeply copying a given {@code ConfigurationParameter} instance.
     * 
     * 
     * @param o
     ...
     */
    public ConfigurationParameter(final ConfigurationParameter o) {
        // CC-XJC Version 2.0.1 Build 2012-03-02T12:09:12+0000
        super();
        if (o == null) {
            throw new NullPointerException("Cannot create a copy of 'ConfigurationParameter' from 'null'.");
        }
        ...
        // CBuiltinLeafInfo: java.lang.String
        this.parameterType = ((o.parameterType == null)?null:o.getParameterType());
    }
    ...
    public ConfigurationParameter clone() {
        try {
            {
                // CC-XJC Version 2.0.1 Build 2012-03-02T12:09:12+0000
                final ConfigurationParameter clone = ((ConfigurationParameter) super.clone());
                // CBuiltinLeafInfo: java.lang.String
                ...
                // CBuiltinLeafInfo: java.lang.String
                clone.parameterType = ((this.parameterType == null)?null:this.getParameterType());
                return clone;
            }
