...
//TODO: Complex Power nie kleiner 0!
//TODO: Phi
...
public class ComplexPowerUtil {
	...
	public ComplexPowerUtil(double power, int powerType, double cosPhi, boolean inductive) throws Exception {
		...
		if (powerType == 0) {
			if (cosPhi == 0 || power == 0) {
				//TODO
				System.out.println("ERROR: Impossible to compute reactivePower and complexPower with activePower = 0 or cosPhi = 0! Setting activePower, reactivePower, complexPower and cosPhi to 0.");
				this.activePower = 0;
		...
		// 1: reactivePower
			...
			if (!(activePower == activePower)) { //ACHTUNG: NaN!!!
				//TODO
				System.out.println("ERROR: Impossible to compute activePower and complexPower with given input values! Setting activePower, reactivePower, complexPower and cosPhi to 0.");
				this.activePower = 0;
				this.reactivePower = 0;
				this.complexPower = 0;
				this.cosPhi = 0;
		...
		if (powerTypeToKeep == 0) {
			if (cosPhi == 0) {
				if (this.activePower != 0) {
					//TODO
					System.out.println("ERROR: Impossible to keep activePower with cosPhi = 0! Setting activePower to 0. Keeping complexPower. Adjusting reactivePower to complexPower.");
					this.activePower = 0;
					this.reactivePower = this.complexPower;
				}
				else {
					//TODO
					System.out.println("ERROR: Impossible to keep activePower with cosPhi = 0! Keeping complexPower. Adjusting reactivePower to complexPower.");
					this.reactivePower = this.complexPower;
				}
			}
			else {
