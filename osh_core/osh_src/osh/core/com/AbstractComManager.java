 ...
 *
 */
public abstract class AbstractComManager extends OCComponent implements IRealTimeSubscriber, ILifeCycleListener, IDriverDataSubscriber, IOCDataPublisher {

	private HALComDriver comDriver;
	private UUID uuid;
	 ...
	 * @param uuid
	 */
	public AbstractComManager(IOSHOC controllerbox, UUID uuid) {
		super(controllerbox);
		this.uuid = uuid;
	}
	...
	public void setOcDataSubscriber(IOCDataSubscriber monitorObject) {
		this.comDriver = (HALComDriver) monitorObject;
	}
	...
	public HALComDriver getComDriver() {
	...
	public void updateOcDataSubscriber(IHALExchange halexchange) throws OSHException {
		if (this.comDriver != null) {
			this.comDriver.onDataFromOcComponent(halexchange);
		}
		else {
			//NOTHING
