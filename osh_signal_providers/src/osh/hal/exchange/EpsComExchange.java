 ...
 *
 */
public class EpsComExchange extends HALComExchange {

	 private Map<VirtualCommodity,PriceSignal> priceSignals;
	 ...
	 public EpsComExchange(
			 UUID deviceID, 
			 Long timestamp,
			 Map<VirtualCommodity,PriceSignal> priceSignals) {
	...
	public Map<VirtualCommodity,PriceSignal> getPriceSignals() {
		return priceSignals;
	}
